...
namespace ShortMenuLoader
{
	...
	public class Main : BaseUnityPlugin
	{
		...
		public static Dictionary<MPN, List<SceneEdit.SMenuItem>> AllItemDic = new Dictionary<MPN, List< SceneEdit.SMenuItem>>(); //MPN

		private void Awake()
		{
			foreach (int item in Enum.GetValues(typeof(MPN)))
			{
				AllItemDic.Add((MPN)item, new List<SceneEdit.SMenuItem>());
			}
